...
function closeAuthModalOnOutside(e) {
...
function handleAuthSubmit(e, type) {
  e.preventDefault();
  // Güvenlik kuralı gereği hiçbir veri kaydedilmiyor ve sunucu isteği yapılmıyor.
  alert("Bu özellik canlı entegrasyon aşamasında aktif edilecektir.");
  closeAuthModal();
}
